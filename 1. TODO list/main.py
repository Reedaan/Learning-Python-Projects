try:
    data = open("/home/odinproject/repos/Learning-Python-Projects/1. TODO list/tasks.txt", "r").readlines()
    task_list = [line.strip("\n") for line in data]
except FileNotFoundError:
    data = open("/home/odinproject/repos/Learning-Python-Projects/1. TODO list/tasks.txt", "x")
    task_list = []
...
def save_task(task_list):
    with open("/home/odinproject/repos/Learning-Python-Projects/1. TODO list/tasks.txt", "w") as f:
